...
import { InputChange } from 'native-base/lib/typescript/components/composites/Typeahead/useTypeahead/types'
...
const AnimatesHStack = Animated.createAnimatedComponent(HStack)
...
const AnimatedTaskLabel = memo((props: Props) => {
  ...
  const striketrhoughStyles = useAnimatedStyle(
    () => ({
  ...
  return (
    <Pressable onPress={onPress}>
      <AnimatesHStack alignItems="center" style={[hstackAnimatedStyles]}>
        <AnimatedText
          fontSize={19}
          noOfLines={1}
          isTruncated
